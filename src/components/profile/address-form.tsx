      ...
      <form onSubmit={handleSubmit}>
        <CardContent className="px-0 space-y-6">
          <div className="flex flex-col gap-2">
            <label htmlFor="address-street" className="text-sm font-semibold text-slate-700">Đường / Số nhà</label>
            <Input
              id="address-street"
              value={street}
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div className="flex flex-col gap-2">
              <label htmlFor="address-district" className="text-sm font-semibold text-slate-700">Quận / Huyện</label>
              <Input
                id="address-district"
                value={district}
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="address-city" className="text-sm font-semibold text-slate-700">Thành phố / Tỉnh</label>
              <Input
                id="address-city"
                value={city}
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="address-gps" className="text-sm font-semibold text-slate-700">Tọa độ GPS</label>
            <Input
              id="address-gps"
              value={gps}
