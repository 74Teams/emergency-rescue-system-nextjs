    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md bg-white rounded-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-2">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="contact-relationship" className="text-sm font-semibold text-slate-700">
              Mối quan hệ <span className="text-destructive">*</span>
            </label>
            <Select value={relationship} onValueChange={setRelationship}>
              <SelectTrigger id="contact-relationship" className="h-10 border-slate-200 rounded-lg px-3">
      ...
      <Card className="border border-slate-200 shadow-sm bg-white rounded-2xl p-6 md:p-8 ring-0">
        <CardHeader className="p-0 mb-6 flex flex-col gap-1.5 w-full">
          <div className="flex items-center justify-between flex-wrap gap-4 w-full">
            ...
            <Button onClick={handleAddNew} className="h-9 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm transition-colors">
        ...
        <CardContent className="px-0 pt-4">
          {contactList.length === 0 ? (
            <div className="flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-slate-200 py-12 text-center">
              ...
              <Button variant="outline" onClick={handleAddNew} className="h-9 px-4 border border-slate-200 rounded-lg mt-2 text-sm hover:bg-slate-50 text-slate-700 font-semibold transition-colors">
