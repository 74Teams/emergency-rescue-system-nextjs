...
import { MissionSummary, CreateMissionInput, UpdateMissionStatusInput, MissionTimelineItem } from "./missions.types";
...
export const missionsApi = {
  ...
  detail(missionId: string) {
    return apiRequest<ApiResponse<MissionSummary & { request?: any; rescueTeam?: any }>>({
      method: "GET",
  ...
  finish(missionId: string, payload: Pick<UpdateMissionStatusInput, "changedById" | "note">) {
    return apiRequest<ApiResponse<null>>({
      method: "PUT",
  ...
  abort(missionId: string, payload: Pick<UpdateMissionStatusInput, "changedById" | "note">) {
    return apiRequest<ApiResponse<null>>({
      method: "PUT",
