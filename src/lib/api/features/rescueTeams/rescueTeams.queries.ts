...
import { CreateRescueTeamInput, RescueTeamQueryParams } from "./rescueTeams.types";

export const rescueTeamKeys = {
  all: ["rescue-teams"] as const,
  lists: () => [...rescueTeamKeys.all, "list"] as const,
  list: (params: RescueTeamQueryParams) => [...rescueTeamKeys.lists(), params] as const,
  ...
  missions: (id: string) => [...rescueTeamKeys.detail(id), "missions"] as const,
};
